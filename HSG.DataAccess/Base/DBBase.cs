    ...
    public class DBBase
    {
        ...
        public class Execute : Connection
        {
            ...
            public static bool ExecuteUpdate(string strValue, DataSet dsValue)
            {
                try
                {
                    SqlDataAdapter adapter = new SqlDataAdapter(strValue, DBBase.Connection.DBConnection.ConnectionString);
            ...
            public static bool ExecuteUpdate(string strValue, string strValue1, DataSet dsValue)
            {
                try
                {
                    SqlDataAdapter adapter = new SqlDataAdapter(strValue1, DBBase.Connection.GetConnectionString(strValue));
                    SqlCommandBuilder builder = new SqlCommandBuilder(adapter);
                    adapter.Update(dsValue.Tables[0]);
                    return true;
                }
